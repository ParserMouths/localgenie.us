...
const dummyData = {
	imgs:[require('../Assets/vendor-1.png'), require('../Assets/vendor-2.png'), require('../Assets/vendor-3.png')],
		...
		<div className = {props.className}>
			<div className = "vendor-home-page">
				...
				<div className = "carousel-wrapper">
					<Carousel showArrows={true} showThumbs={false} dynamicHeight={true} infiniteLoop={true} autoPlay={true}>
				...
				<div className = "vendor-content">
					<hr/>
					<h2 className={editing?"edit":""} contentEditable={editing}>{dummyData['title']}</h2>
					<div className='btns'>
						<Mybutton outlined={true} className='btn-x'> Navigate </Mybutton>
					...
					<h3>Offering</h3>
					<p className={editing?"edit":""} contentEditable={editing}>{dummyData['description']}</p>
